...
Implementation by David Eppstein. (see the PADS library)

http://katlas.org/wiki/Drawing_Planar_Diagrams#How_does_it_work.3F
https://cran.r-project.org/web/packages/packcircles/vignettes/graph_packing.html
"""
